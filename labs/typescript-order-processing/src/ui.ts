...
app.innerHTML = `
  ...
  <aside class="sidebar"><nav><span>CONTROL ROOM</span><a class="active" href="#pipeline">⌁ <b>Pipeline</b></a><a href="#events">≡ <b>Event log</b><em id="event-badge">0</em></a><span>LEARNING</span><a href="#pipeline">◇ <b>Arquitetura</b></a><a href="#exercises">⌘ <b>Exercícios</b><em>4</em></a></nav><div class="study-card"><span>LAB PROGRESS</span><strong>TypeScript resiliente</strong><div><i style="width:80%"></i></div><small>4 de 5 módulos implementados</small></div><footer><i></i><div><strong>Runtime conectado</strong><small>In-memory · local</small></div></footer></aside>
  <main>
