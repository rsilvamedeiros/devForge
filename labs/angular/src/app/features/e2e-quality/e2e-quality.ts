...
export class E2eQuality {
  ...
  readonly commands=[{label:'Executar',value:'npm run test:e2e:angular'},{label:'Modo visual',value:'npm run test:e2e:angular:ui'},{label:'Relatório',value:'npx playwright show-report labs/angular/playwright-report'}];
